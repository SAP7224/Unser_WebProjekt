...
<body>
	...
	<nav id="navbar">
		<ul>
			...
			<li><a href="Main.jsp" class="active">Privatkunden</a></li>
			<li><a href="Firmenkunden.jsp">Firmenkunden</a></li>
			<li><a href="Immobilien.jsp">Immobilien</a></li>
			<li><a href="Karriere.jsp">Karriere</a></li>
			<li><a href="Banking-Login.jsp">Banking-Login</a></li>
		</ul>
	</nav>
	...
	<div class="grid-container">
		<div class="grid-item">
			Neue Bäume für den deutschen Wald<br>
			<br>Die Klima-Initiative der Gemeinschaftsbank hat über 1,1
			Millionen Bäume gepflanzt.<br>
			<br>
			<a href="#">Mehr</a>
		</div>
		<div class="grid-item">
	...
	<article>
		...
		<p>
			Klicken sie zum Einloggen <a href="Banking-Login.jsp"
				class="black-anchor">hier</a>.
		</p>
		<h3>Passwort vergessen?</h3>
		<p>
			Hilfe finden Sie <a href="passwortReset.jsp" class="black-anchor">hier</a>.
		</p>
	</article>
