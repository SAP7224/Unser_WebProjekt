...
<body>
    ...
    <nav>
        <ul>
            <li><a href="Banking-Login.jsp" class="white-anchor">Zurück zum Login</a></li>
    ...
    <article>
        ...
        <ul>
            ...
            <li>Vergewissern Sie sich, dass Sie die neueste Version Ihres Browsers verwenden, um beste Leistung und Sicherheit zu gewährleisten.
        </ul>
    </article>
