...
<body>
    ...
    <aside>
        ...
        <div>
            <a href="Main.jsp">Zurück zur Startseite</a>
        </div>
    </aside>
    ...
    <article>
        ...
        <p>Erste Fehlerbehandlung finden Sie <a href="hilfe.jsp" class="black-anchor">hier</a>.</p>
        <p>Oder kontaktieren Sie uns <a href="kontakt.jsp" class="black-anchor">hier</a>.</p>
    </article>
